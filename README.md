...
I analysed the Banking Churn problem where the bank was lossing around 185M in customer assets. TO reduce the churn I make a project. Where I analysed raw data into mening full action.
